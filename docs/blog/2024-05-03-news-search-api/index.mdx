...
```json title="news-properties.json"
{
  "properties": {
    "id": {
      "type": "keyword",
...
```json title="search-query.json"
{
  ...
  "query": {
    "bool": {
      ...
      "should": [
        { "prefix": { "title.korean": { "value": "대구", "boost": 15 } } },
        { "term": { "title.ngram": { "value": "대구", "boost": 10 } } },
        { "term": { "title.edge_ngram": { "value": "대구", "boost": 8 } } },
        { "prefix": { "content.korean": { "value": "대구", "boost": 13 } } },
        { "term": { "content.ngram": { "value": "대구", "boost": 6 } } },
        { "term": { "content.edge_ngram": { "value": "대구", "boost": 4 } } }
      ],
